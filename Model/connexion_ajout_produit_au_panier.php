...
$result_select_panier->bindValue(':id_produit', 1, PDO::PARAM_INT);
...
if(count($tableau_select_panier) == 0) {
    ...
    $requete_produit = "UPDATE panier SET quantite = :quantite, id_produit = :id_produit, id_compte_client = :id_compte_client";
